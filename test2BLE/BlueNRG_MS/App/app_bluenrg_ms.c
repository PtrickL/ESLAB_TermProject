...
/* USER CODE BEGIN PV */
static uint8_t last_state = 255;   // impossible value
extern volatile uint8_t door_state_global;
extern volatile uint8_t event_knock_detected;     // 敲門/撞擊事件
extern volatile uint8_t event_handle_twist;
/* USER CODE END PV */
