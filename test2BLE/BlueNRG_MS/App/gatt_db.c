...
#define COPY_CUSTOM_SERVICE_UUID(uuid_struct) \
  COPY_UUID_128(uuid_struct, 0xAA,0xBB,0xCC,0xDD,0xEE,0xFF,0x11,0x22,0x33,0x44,0x55,0x66,0x00,0x00,0x00,0x01)

// Char 1 — 事件 A
#define COPY_CHAR1_UUID(uuid_struct) \
  COPY_UUID_128(uuid_struct, 0xAA,0xBB,0xCC,0xDD,0xEE,0xFF,0x11,0x22,0x33,0x44,0x55,0x66,0x00,0x00,0x00,0x02)

// Char 2 — 事件 B
#define COPY_CHAR2_UUID(uuid_struct) \
  COPY_UUID_128(uuid_struct, 0xAA,0xBB,0xCC,0xDD,0xEE,0xFF,0x11,0x22,0x33,0x44,0x55,0x66,0x00,0x00,0x00,0x03)

// Char 3 — 事件 C
#define COPY_CHAR3_UUID(uuid_struct) \
  COPY_UUID_128(uuid_struct, 0xAA,0xBB,0xCC,0xDD,0xEE,0xFF,0x11,0x22,0x33,0x44,0x55,0x66,0x00,0x00,0x00,0x04)

uint16_t CustomServiceHandle;
uint16_t Char1Handle;
uint16_t Char2Handle;
uint16_t Char3Handle;
